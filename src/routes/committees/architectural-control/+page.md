...
description: "Reviews and approves all exterior improvement projects to ensure compliance with FCR Covenants."
---
...
<script>
  ...
  const frontmatter = {
    committee: {
      chairs: ["Mary Ann Bryant", "Erica Harrington"],
      members: ["Gale Marinelli", "Linda Johnson", "Ginette Chapman"],
      email: "architectural-control@fallscreekranch.org"
    }
  };
</script>
...
The Architectural Control Committee (ACC) reviews and approves all exterior construction and remodeling projects to ensure they comply with FCR Covenants and committee rules.
...
<FileHistory file="src/routes/committees/architectural-control/+page.md" />

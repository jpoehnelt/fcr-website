...
<script>
  import CommitteeList from '$lib/components/CommitteeList.svelte';
...
This position supervises our Ranch Caretaker, manages ranch equipment (including machinery, vehicles, insurance, and maintenance), and serves as the primary contact between the Board, committees, and residents on matters involving the Caretaker's duties. Residents are asked to go through the liaison rather than contacting the Ranch Caretaker directly.
...
<FileHistory file="src/routes/committees/+page.md" />
